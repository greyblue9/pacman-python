...
Sub Form_Resize()
	...
	If tbTileWidth < 1 Then
		tbTileWidth = 1
	End If
	If tbTileHeight < 1 Then
		tbTileHeight = 1
	End If
	If eTileWidth < 1 Then
		eTileWidth = 1
	End If
	If eTileHeight < 1 Then 
		eTileHeight = 1
	End If
...
Sub itmSpriteDelete_Click()
	DeleteSelectedSprite

	DrawScreen
End Sub

Sub itmSpriteList_Click()
...
Sub picEdit_KeyDown(KeyCode As Integer, Shift As Integer)
	On Error Resume Next
...
Sub picEdit_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
Sub picEdit_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
...
Function MakeSmartWall(r As Integer, c As Integer)
...
Function IsWall(MapTileID As Integer) As Boolean
...
Sub picTiles_KeyDown(KeyCode As Integer, Shift As Integer)
	picEdit_KeyDown KeyCode, Shift
End Sub

Sub picTiles_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
